package  
{
	public class Signals 
	{
		...
		public static const APP_EXIT				:int = 1010;
		...
		public static const SHOOT_KEYUP				:int = 2012;
		public static const SHOOT_KEYDOWN			:int = 2013;
		
		// movement
		public static const MOVEMENT_PAUSE			:int = 3000;
		public static const MOVEMENT_UNPAUSE		:int = 3001;
		
		// action
		public static const ACTION_EXECUTE			:int = 4000;
		
		// animation
		public static const ANIM_PLAY				:int = 5000;
		
		// projectile
		public static const PROJECTILE_ADD			:int = 7000;
		public static const PROJECTILE_REMOVE		:int = 7001;

		// effects
		public static const EFFECT_ADD				:int = 8000;
		
		// game specific
		public static const EXPLOSION_EVENT			:int = 9000;
		...
		public static const STALIN_DIED				:int = 9005;
		public static const PLAYER_DIED				:int = 9006;
		public static const SECRET_PUSH_BLOCK_USED	:int = 9007;
