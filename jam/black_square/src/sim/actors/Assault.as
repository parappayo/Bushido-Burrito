package sim.actors 
{
	...
	public class Assault extends Enemy
	{
		...
		public static const ShootPlayerDistanceMax :Number = 300.0;
		...
		public function Assault(movementSpeed:Number, textureAtlas:TextureAtlas) 
		{
			...
			bank.add(Animations.WALK, new AnimState4Way(textureAtlas, "nkvd_walk"));
			bank.add(Animations.IDLE, new AnimState4Way(textureAtlas, "nkvd_idle"));
			animation = new Animation(bank);
			animation.play(Animations.IDLE);

			var actionBank:ActionBank = new ActionBank();
			actionBank.add(Actions.SHOOT, new ActionStateShoot("enemy_bullet", 250, 2, false));
		...
		{
			SoundPlayer.playRandom(Audio.enemyDmgSoundList, Audio.VOLUME_SFX-0.1);
