package sim.components.animstates 
{
	...
	{	
		...
		public function AnimState4Way(textureAtlas:TextureAtlas, animName:String, fps:int = Settings.SpriteFramerate)
		{
		...
		private function updateAnimation(actor:SpriteActor):void
		{
			...
			else if (staleOrientation(actor))
			{
