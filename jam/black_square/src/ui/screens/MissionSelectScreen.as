package ui.screens 
{
	...
	public class MissionSelectScreen extends Screen
	{
		...
		public function MissionSelectScreen(parent :Flow, game :Game) 
		{
			...
			var numMissions :int = Settings.StartingLevels.length;
			...
			var caption :TextField = new TextField(160, 30, "", "blacksquare", 18, 0xffffff);
			...
			{
				caption = new TextField(160, 30, "", "blacksquare", 18, 0xffffff);
			...
			_cursor = new Image(Assets.ElementsTextures.getTexture("helmut_idle_right1"));
