				...
				case FlowStates.VICTORY_SCREEN:
					{
						...
						SoundPlayer.play(Audio.revelryMusic, Audio.VOLUME_SFX_LOUD);
					}
					break;
				...
				case FlowStates.GAME_OVER_SCREEN:
					{
						...
						_child.changeState(FlowStates.ACTIVE);
						SoundPlayer._musicChannel.stop();
						SoundPlayer.play(Audio.deathMusic, Audio.VOLUME_SFX);
					}
					break;
				...
				case FlowStates.GAME_OVER_SCREEN:
					{
						...
						SoundPlayer._musicChannel = SoundPlayer.playLooping(Audio.mx1Music, Audio.VOLUME_MUSIC);
					}
					break;
