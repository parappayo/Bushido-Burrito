package ui.flows 
{
	public class FlowStates 
	{
		...
		public static const RADIO_DIALOG		:int = 2007;
		...
		public static const GHOSTPXS_SPLASH_SCREEN	:int = 2011;
		public static const MISSION_SELECT_SCREEN	:int = 2012;
		public static const CREDITS_SCREEN		:int = 2013;
	}
