package ui.flows 
{
	...
	public class FrontEndFlow extends Flow
	{
		...
		private var _kremlinBellsChannel: SoundChannel;
				...
				case FlowStates.INTRO_DIALOG:
					{
						_child = _introDialog;
						_child.changeState(FlowStates.ACTIVE);
						_kremlinBellsChannel = SoundPlayer.play(Audio.kremlinBells, 0.6);
					}
					break;
