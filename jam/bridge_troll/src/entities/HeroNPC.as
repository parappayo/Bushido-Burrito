...
package entities 
{
	...
	public class HeroNPC extends Component
	{
		...
		override public function start(prefabArgs :Object, spawnArgs :Object) :void
		{
			...
			_clip.addAnimation("idle", Assets.EntitiesAtlas.getTextures("hero_stand"), Settings.SpriteFramerate);
			_clip.addAnimation("walk", Assets.EntitiesAtlas.getTextures("hero_walk_left"), Settings.SpriteFramerate);
