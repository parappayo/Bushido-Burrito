package sim.components.animation 
{
	...
	public class AnimStateSingle implements AnimState 
	{
		...
		public function AnimStateSingle(textureAtlas:TextureAtlas, animName:String, loop:Boolean = false)
		{
			_loop = loop;
			_clip = new MovieClip(textureAtlas.getTextures(animName), Settings.SpriteFramerate);
			_isDone = false;
		}
