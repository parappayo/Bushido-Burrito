package  
{
	public class Signals 
	{
		...
		public static const AIM_START				:int = 2013;
		public static const AIM_HOLD				:int = 2014;
		public static const AIM_RELEASE				:int = 2015;
		...
		public static const BOSS_DIED				:int = 9005;
