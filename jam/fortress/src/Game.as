package  
{
	...
	public class Game extends Sprite
	{
		...
		{
			_level.loadLevel(levelName, 0, 0);
		}
		
		public function generateLevel() :void
		{
			var mazeData :MazeData = new MazeData(Settings.MazeWidth, Settings.MazeHeight);
			mazeData.verbose = Settings.Verbose;
			mazeData.generate();
			_level.generate(mazeData);
		}
		...
		public function get enemies() :EnemyManager
		{
		...
		public function checkCollision(pos :WorldPosition, ignore :SpriteActor) :Boolean
		{
			...
			const xOffset:Number = Settings.TileW / 2;
			const yOffset:Number = Settings.TileH / 2;
