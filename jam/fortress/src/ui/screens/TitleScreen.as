package ui.screens 
{
	...
	public class TitleScreen extends Screen
	{
		...
		override protected function handleEnterState(oldState :int, newState :int) :void
		{
			...
			{
				_img = new Image(Screens.TitleTexture);
				_caption = new TextField(Settings.ScreenWidth, 30, "Press [" + Settings.AcceptButton + "] to begin", "fortress", 18, 0xffffff);
				_caption.y = 540;
		...
		override public function handleSignal(signal :int) :void
		{
			...
			if (_timeElapsedInState > MinScreenDuration && signal == Signals.ACCEPT_KEYUP && !_exit)
			{
				...
				_timer = 0;
				_exit = true;
				SoundPlayer.play(Audio.sfx_disc_fly_01, Settings.VolumeSfx);
			}
		}
