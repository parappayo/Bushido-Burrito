package  
{
	public class Signals 
	{
		...
		public static const KEYDOWN_EVENT			:int = 2014;
		public static const KEYUP_EVENT				:int = 2015;
		public static const TOUCH_EVENT				:int = 2016;
		...
		public static const SELECTED_STATE_CHANGED	:int = 3012;
		public static const PLAYER_TURN_START		:int = 3013;
		public static const AI_TURN_START			:int = 3014;
		public static const PLAYER_ATTACK			:int = 3015;
		public static const AI_ATTACK				:int = 3016;
		public static const PLAYER_CHARGE_ATTACK	:int = 3017;
		public static const AI_CHARGE_ATTACK		:int = 3018;
		public static const UNIT_DEFEATED			:int = 3019;
	}
