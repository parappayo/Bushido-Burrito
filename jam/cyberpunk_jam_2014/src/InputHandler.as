package  
{
	...
	public class InputHandler extends Sprite
	{
		...
		private var _keyState :Dictionary;
		...
		{
			_keyState[keyEvent.keyCode] = false;
		...
		{
			// avoid repeating key press events
			if (_keyState[keyEvent.keyCode]) { return; }
			_keyState[keyEvent.keyCode] = true;
