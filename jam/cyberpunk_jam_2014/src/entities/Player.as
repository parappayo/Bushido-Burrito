...
package entities 
{
	...
	public class Player extends Component
	{
		...
		override public function start(prefabArgs :Object, spawnArgs :Object) :void
		{
			...
			_clip.addAnimation("idle", Assets.EntitiesAtlas.getTextures("player_down"), Settings.SpriteFramerate);
			_clip.addAnimation("walk", Assets.EntitiesAtlas.getTextures("player_walk_left"), Settings.SpriteFramerate);
