...
:: Android packaging
set AND_CERT_NAME="Unafraid_Android"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\UnafraidAndroid.p12
...
set IOS_PROVISION=cert\UnafraidAndroid.mobileprovision
...
set APP_ID=air.UnafraidAndroid

:: Output packages
set DIST_PATH=dist
set DIST_NAME=UnafraidAndroid
